...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_chemm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CHEMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    while k <= i__3 {
                        ...
                        q__2.r = (*b.offset(i__4 as isize)).r * q__3.r
                            - (*b.offset(i__4 as isize)).i * q__3.i;
                        q__2.i = (*b.offset(i__4 as isize)).r * q__3.i
                            + (*b.offset(i__4 as isize)).i * q__3.r;
            ...
            while j <= i__1 {
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    while k <= i__2 {
                        ...
                        i__3 = k + j * b_dim1;
                        r_cnjg_0(&mut q__3, &mut *a.offset((k + i__ * a_dim1) as isize));
                        q__2.r = (*b.offset(i__3 as isize)).r * q__3.r
                            - (*b.offset(i__3 as isize)).i * q__3.i;
                        q__2.i = (*b.offset(i__3 as isize)).r * q__3.i
                            + (*b.offset(i__3 as isize)).i * q__3.r;
                        q__1.r = temp2.r + q__2.r;
                        q__1.i = temp2.i + q__2.i;
                        temp2.r = q__1.r;
                        temp2.i = q__1.i;
