...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_sswap(
    mut n: *mut integer,
    mut sx: *mut real,
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        if !(m == 0 as libc::c_int as libc::c_long) {
            ...
            while i__ <= i__1 {
                stemp = *sx.offset(i__ as isize);
                *sx.offset(i__ as isize) = *sy.offset(i__ as isize);
                *sy.offset(i__ as isize) = stemp;
                i__ += 1
                /* L30: */
            }
        ...
        while i__ <= i__1 {
            ...
            *sx.offset(i__ as isize) = *sy.offset(i__ as isize);
            *sy.offset(i__ as isize) = stemp;
            stemp = *sx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            *sx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize) =
                *sy.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            *sy.offset((i__ + 1 as libc::c_int as libc::c_long) as isize) = stemp;
            stemp = *sx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            *sx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize) =
                *sy.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            *sy.offset((i__ + 2 as libc::c_int as libc::c_long) as isize) = stemp;
        ...
        i__ = 1 as libc::c_int as integer;
        while i__ <= i__1 {
            stemp = *sx.offset(ix as isize);
            *sx.offset(ix as isize) = *sy.offset(iy as isize);
            *sy.offset(iy as isize) = stemp;
            ix += *incx;
            iy += *incy;
            i__ += 1
            /* L10: */
