...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_cher2k(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CHER2K\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
        ...
        if upper != 0 {
            ...
            while j <= i__1 {
                ...
                while l <= i__2 {
                    ...
                    {
                        r_cnjg_0(&mut q__2, &mut *b.offset((j + l * b_dim1) as isize));
                        q__1.r = (*alpha).r * q__2.r - (*alpha).i * q__2.i;
                        q__1.i = (*alpha).r * q__2.i + (*alpha).i * q__2.r;
                        temp1.r = q__1.r;
                        temp1.i = q__1.i;
                        i__3 = j + l * a_dim1;
                        q__2.r = (*alpha).r * (*a.offset(i__3 as isize)).r
                            - (*alpha).i * (*a.offset(i__3 as isize)).i;
                        q__2.i = (*alpha).r * (*a.offset(i__3 as isize)).i
                        ...
                        i__4 = j + j * c_dim1;
                        i__5 = j + l * a_dim1;
                        q__2.r = (*a.offset(i__5 as isize)).r * temp1.r
                            - (*a.offset(i__5 as isize)).i * temp1.i;
                        q__2.i = (*a.offset(i__5 as isize)).r * temp1.i
                            + (*a.offset(i__5 as isize)).i * temp1.r;
                        i__6 = j + l * b_dim1;
                        q__3.r = (*b.offset(i__6 as isize)).r * temp2.r
                            - (*b.offset(i__6 as isize)).i * temp2.i;
                        q__3.i = (*b.offset(i__6 as isize)).r * temp2.i
        ...
        while j <= i__1 {
            ...
            while i__ <= i__2 {
                ...
                while l <= i__3 {
                    ...
                    temp1.r = q__1.r;
                    temp1.i = q__1.i;
                    r_cnjg_0(&mut q__3, &mut *b.offset((l + i__ * b_dim1) as isize));
                    i__4 = l + j * a_dim1;
                ...
                if i__ == j {
                    if *beta == 0.0f32 {
                        ...
                        q__1.r = q__2.r + q__3.r;
                        q__1.i = q__2.i + q__3.i;
                        r__1 = *beta * (*c__.offset(i__4 as isize)).r + q__1.r;
                        (*c__.offset(i__3 as isize)).r = r__1;
                        (*c__.offset(i__3 as isize)).i = 0.0f32
                    }
                } else if *beta == 0.0f32 {
