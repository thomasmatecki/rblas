...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zdscal(
    mut n: *mut integer,
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            ...
            i__3 = i__;
            z__1.r =
                z__2.r * (*zx.offset(i__3 as isize)).r - z__2.i * (*zx.offset(i__3 as isize)).i;
            z__1.i =
                z__2.r * (*zx.offset(i__3 as isize)).i + z__2.i * (*zx.offset(i__3 as isize)).r;
