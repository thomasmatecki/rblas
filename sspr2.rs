...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_sspr2(mut uplo: *mut libc::c_char,
                                   mut n: *mut integer, mut alpha: *mut real,
                                   mut x: *mut real, mut incx: *mut integer,
                                   mut y: *mut real, mut incy: *mut integer,
                                   mut ap: *mut real) -> libc::c_int {
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"SSPR2 \x00" as *const u8 as *const libc::c_char as
