...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_dger(mut m: *mut integer, mut n: *mut integer,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"DGER  \x00" as *const u8 as *const libc::c_char as
                      *mut libc::c_char, &mut info);
        return 0 as libc::c_int
    }
    /*     Quick return if possible. */
    if *m == 0 as libc::c_int as libc::c_long ||
           *n == 0 as libc::c_int as libc::c_long || *alpha == 0.0f64 {
        return 0 as libc::c_int
    }
