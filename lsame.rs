...
*/
#[no_mangle]
pub unsafe extern "C" fn lsame_(mut ca: *mut libc::c_char,
                                mut cb: *mut libc::c_char) -> logical {
...
/*     .. */
    ...
    ret_val =
        (*(ca as *mut libc::c_uchar) as libc::c_int ==
             *(cb as *mut libc::c_uchar) as libc::c_int) as libc::c_int as
            logical;
...
/*     ICHAR('A') on an EBCDIC machine. */
    ...
    if zcode == 90 as libc::c_int as libc::c_long ||
           zcode == 122 as libc::c_int as libc::c_long {
        /*        ASCII is assumed - ZCODE is the ASCII code of either lower or */
/*        upper case 'Z'. */
        if inta >= 97 as libc::c_int as libc::c_long &&
               inta <= 122 as libc::c_int as libc::c_long {
            inta += -(32 as libc::c_int) as libc::c_long
        }
        if intb >= 97 as libc::c_int as libc::c_long &&
               intb <= 122 as libc::c_int as libc::c_long {
...
/*        upper case 'Z'. */
        if inta >= 129 as libc::c_int as libc::c_long &&
               inta <= 137 as libc::c_int as libc::c_long ||
        ...
        if intb >= 129 as libc::c_int as libc::c_long &&
               intb <= 137 as libc::c_int as libc::c_long ||
...
/*        plus 128 of either lower or upper case 'Z'. */
        if inta >= 225 as libc::c_int as libc::c_long &&
               inta <= 250 as libc::c_int as libc::c_long {
            inta += -(32 as libc::c_int) as libc::c_long
        }
        if intb >= 225 as libc::c_int as libc::c_long &&
               intb <= 250 as libc::c_int as libc::c_long {
            intb += -(32 as libc::c_int) as libc::c_long
        }
    }
