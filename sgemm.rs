...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_sgemm(mut transa: *mut libc::c_char,
                                   mut transb: *mut libc::c_char,
                                   mut m: *mut integer, mut n: *mut integer,
                                   mut k: *mut integer, mut alpha: *mut real,
                                   mut a: *mut real, mut lda: *mut integer,
                                   mut b: *mut real, mut ldb: *mut integer,
                                   mut beta: *mut real, mut c__: *mut real,
...
/*     and  columns of  A  and the  number of  rows  of  B  respectively. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"SGEMM \x00" as *const u8 as *const libc::c_char as
    ...
    if *m == 0 as libc::c_int as libc::c_long ||
           *n == 0 as libc::c_int as libc::c_long ||
           (*alpha == 0.0f32 || *k == 0 as libc::c_int as libc::c_long) &&
               *beta == 1.0f32 {
        return 0 as libc::c_int
    }
    ...
    if notb != 0 {
        if nota != 0 {
            ...
            while j <= i__1 {
                ...
                while l <= i__2 {
                    if *b.offset((l + j * b_dim1) as isize) != 0.0f32 {
        ...
        while j <= i__1 {
            ...
            l = 1 as libc::c_int as integer;
            while l <= i__2 {
                if *b.offset((j + l * b_dim1) as isize) != 0.0f32 {
