...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_sgemm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"SGEMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
        ...
        if nota != 0 {
                ...
                while l <= i__2 {
                    if *b.offset((l + j * b_dim1) as isize) != 0.0f32 {
                        ...
                        while i__ <= i__3 {
                            ...
                            *fresh0 += temp * *a.offset((i__ + l * a_dim1) as isize);
                            i__ += 1
                            /* L90: */
                            /* L70: */
                        }
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    l = 1 as libc::c_int as integer;
                    while l <= i__3 {
                        temp += *a.offset((l + i__ * a_dim1) as isize)
                    ...
                    if *beta == 0.0f32 {
                        ...
                        *c__.offset((i__ + j * c_dim1) as isize) =
                            *alpha * temp + *beta * *c__.offset((i__ + j * c_dim1) as isize)
                    }
                    i__ += 1
                }
                j += 1
            ...
            while l <= i__2 {
                if *b.offset((j + l * b_dim1) as isize) != 0.0f32 {
                    ...
                    while i__ <= i__3 {
                        ...
                        *fresh1 += temp * *a.offset((i__ + l * a_dim1) as isize);
                        i__ += 1
                        /* L170: */
                        /* L150: */
                    }
