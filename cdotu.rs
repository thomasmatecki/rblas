...
/* Complex */
#[no_mangle]
pub unsafe extern "C" fn f2c_cdotu(mut ret_val: *mut complex,
        ...
        while i__ <= i__1 {
            ...
            q__2.r =
                (*cx.offset(i__2 as isize)).r * (*cy.offset(i__3 as isize)).r
                    -
                    (*cx.offset(i__2 as isize)).i *
                        (*cy.offset(i__3 as isize)).i;
            q__2.i =
                (*cx.offset(i__2 as isize)).r * (*cy.offset(i__3 as isize)).i
                    +
                    (*cx.offset(i__2 as isize)).i *
                        (*cy.offset(i__3 as isize)).r;
