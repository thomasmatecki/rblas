...
*/
#[no_mangle]
pub unsafe extern "C" fn f2c_isamax(mut n: *mut integer, mut sx: *mut real,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        smax =
            if *sx.offset(1 as libc::c_int as isize) >=
                   0 as libc::c_int as libc::c_float {
                *sx.offset(1 as libc::c_int as isize)
            } else { -*sx.offset(1 as libc::c_int as isize) } as doublereal as
                real;
        i__1 = *n;
        ...
        while i__ <= i__1 {
            ...
            if !((if r__1 >= 0 as libc::c_int as libc::c_float {
                      r__1
                  } else { -r__1 }) as doublereal <= smax as libc::c_double) {
                ret_val = i__;
                r__1 = *sx.offset(i__ as isize);
                smax =
