...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_cgeru(
    mut m: *mut integer,
    mut n: *mut integer,
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CGERU \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while j <= i__1 {
            i__2 = jy;
            if (*y.offset(i__2 as isize)).r != 0.0f32 || (*y.offset(i__2 as isize)).i != 0.0f32 {
                i__2 = jy;
                q__1.r = (*alpha).r * (*y.offset(i__2 as isize)).r
                    - (*alpha).i * (*y.offset(i__2 as isize)).i;
                q__1.i = (*alpha).r * (*y.offset(i__2 as isize)).i
