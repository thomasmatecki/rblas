...
pub unsafe extern "C" fn f2c_dswap(
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            ...
            *dx.offset(i__ as isize) = *dy.offset(i__ as isize);
            *dy.offset(i__ as isize) = dtemp;
            dtemp = *dx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            *dx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize) =
                *dy.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            *dy.offset((i__ + 1 as libc::c_int as libc::c_long) as isize) = dtemp;
            dtemp = *dx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            *dx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize) =
                *dy.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            *dy.offset((i__ + 2 as libc::c_int as libc::c_long) as isize) = dtemp;
