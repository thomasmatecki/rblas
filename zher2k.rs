...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zher2k(mut uplo: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"ZHER2K\x00" as *const u8 as *const libc::c_char as
    ...
    if *n == 0 as libc::c_int as libc::c_long ||
           ((*alpha).r == 0.0f64 && (*alpha).i == 0.0f64 ||
                *k == 0 as libc::c_int as libc::c_long) && *beta == 1.0f64 {
        return 0 as libc::c_int
    }
...
/*                   C. */
                ...
                if i__ == j {
                    if *beta == 0.0f64 {
                        ...
                        z__1.i = z__2.i + z__3.i;
                        d__1 =
                            *beta * (*c__.offset(i__4 as isize)).r + z__1.r;
                        (*c__.offset(i__3 as isize)).r = d__1;
                        (*c__.offset(i__3 as isize)).i = 0.0f64
                    }
                } else if *beta == 0.0f64 {
