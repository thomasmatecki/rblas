...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zher2k(
    ...
    let mut z__6: doublecomplex = doublecomplex { r: 0., i: 0. };
    /* Builtin functions */
    extern "C" {
        #[link_name = "d_cnjg"]
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZHER2K\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
            ...
            while j <= i__1 {
                ...
                while l <= i__2 {
                    ...
                    if (*a.offset(i__3 as isize)).r != 0.0f64
                        ...
                        || ((*b.offset(i__4 as isize)).r != 0.0f64
                            || (*b.offset(i__4 as isize)).i != 0.0f64)
                    {
                        ...
                        temp1.i = z__1.i;
                        i__3 = j + l * a_dim1;
                        z__2.r = (*alpha).r * (*a.offset(i__3 as isize)).r
                            - (*alpha).i * (*a.offset(i__3 as isize)).i;
                        z__2.i = (*alpha).r * (*a.offset(i__3 as isize)).i
                        ...
                        while i__ <= i__3 {
                            ...
                            i__5 = i__ + j * c_dim1;
                            i__6 = i__ + l * a_dim1;
                            z__3.r = (*a.offset(i__6 as isize)).r * temp1.r
                                - (*a.offset(i__6 as isize)).i * temp1.i;
                            z__3.i = (*a.offset(i__6 as isize)).r * temp1.i
                                + (*a.offset(i__6 as isize)).i * temp1.r;
                            z__2.r = (*c__.offset(i__5 as isize)).r + z__3.r;
                            z__2.i = (*c__.offset(i__5 as isize)).i + z__3.i;
                            i__7 = i__ + l * b_dim1;
                            z__4.r = (*b.offset(i__7 as isize)).r * temp2.r
                                - (*b.offset(i__7 as isize)).i * temp2.i;
                            z__4.i = (*b.offset(i__7 as isize)).r * temp2.i
                        ...
                        i__4 = j + j * c_dim1;
                        i__5 = j + l * a_dim1;
                        z__2.r = (*a.offset(i__5 as isize)).r * temp1.r
                            - (*a.offset(i__5 as isize)).i * temp1.i;
                        z__2.i = (*a.offset(i__5 as isize)).r * temp1.i
                            + (*a.offset(i__5 as isize)).i * temp1.r;
                        i__6 = j + l * b_dim1;
                        z__3.r = (*b.offset(i__6 as isize)).r * temp2.r
                            - (*b.offset(i__6 as isize)).i * temp2.i;
                        z__3.i = (*b.offset(i__6 as isize)).r * temp2.i
        ...
        while j <= i__1 {
            ...
            while i__ <= i__2 {
                ...
                while l <= i__3 {
                    ...
                    z__1.r = temp1.r + z__2.r;
                    z__1.i = temp1.i + z__2.i;
                    temp1.r = z__1.r;
                    temp1.i = z__1.i;
                    d_cnjg_0(&mut z__3, &mut *b.offset((l + i__ * b_dim1) as isize));
                    i__4 = l + j * a_dim1;
                    z__2.r = z__3.r * (*a.offset(i__4 as isize)).r
                        - z__3.i * (*a.offset(i__4 as isize)).i;
                    z__2.i = z__3.r * (*a.offset(i__4 as isize)).i
                ...
                if i__ == j {
                    if *beta == 0.0f64 {
                        ...
                        z__1.r = z__2.r + z__3.r;
                        z__1.i = z__2.i + z__3.i;
                        d__1 = *beta * (*c__.offset(i__4 as isize)).r + z__1.r;
                        (*c__.offset(i__3 as isize)).r = d__1;
                        (*c__.offset(i__3 as isize)).i = 0.0f64
                    }
                } else if *beta == 0.0f64 {
