...
static mut c_b1: doublecomplex =
    { let mut init = doublecomplex{r: 1.0f64, i: 0.0f64,}; init };
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztrsm(mut side: *mut libc::c_char,
                                   ...
                                   mut ldb: *mut integer) -> libc::c_int {
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"ZTRSM \x00" as *const u8 as *const libc::c_char as
                ...
                while j <= i__1 {
                    if (*alpha).r != 1.0f64 || (*alpha).i != 0.0f64 {
                        ...
                        while i__ <= i__2 {
                            ...
                            i__4 = i__ + j * b_dim1;
                            z__1.r =
                                (*alpha).r * (*b.offset(i__4 as isize)).r -
                                    (*alpha).i * (*b.offset(i__4 as isize)).i;
                            z__1.i =
                                (*alpha).r * (*b.offset(i__4 as isize)).i +
                    ...
                    while k >= 1 as libc::c_int as libc::c_long {
                        ...
                        if (*b.offset(i__2 as isize)).r != 0.0f64 ||
                            ...
                            if nounit != 0 {
                                i__2 = k + j * b_dim1;
                                z_div_0(&mut z__1,
                                        &mut *b.offset((k + j * b_dim1) as
                                                           isize),
                                        &mut *a.offset((k + k * a_dim1) as
                                                           isize));
                                ...
                                z__2.i =
                                    (*b.offset(i__5 as isize)).r *
                                        ...
                                        (*b.offset(i__5 as isize)).i *
                                            (*a.offset(i__6 as isize)).r;
                                z__1.r =
                                    (*b.offset(i__4 as isize)).r - z__2.r;
                                z__1.i =
                                    (*b.offset(i__4 as isize)).i - z__2.i;
                                (*b.offset(i__3 as isize)).r = z__1.r;
                                (*b.offset(i__3 as isize)).i = z__1.i;
                                i__ += 1
                                /* L60: */
                    ...
                    while k <= i__2 {
                        ...
                        if (*b.offset(i__3 as isize)).r != 0.0f64 ||
                            ...
                            while i__ <= i__3 {
                                ...
                                i__7 = i__ + k * a_dim1;
                                z__2.r =
                                    (*b.offset(i__6 as isize)).r *
                                        (*a.offset(i__7 as isize)).r -
                                        (*b.offset(i__6 as isize)).i *
                                ...
                                z__2.i =
                                    (*b.offset(i__6 as isize)).r *
                                        ...
                                        (*b.offset(i__6 as isize)).i *
                                            (*a.offset(i__7 as isize)).r;
                                z__1.r =
                                    (*b.offset(i__5 as isize)).r - z__2.r;
                                z__1.i =
                                    (*b.offset(i__5 as isize)).i - z__2.i;
...
/*           or    B := alpha*inv( conjg( A' ) )*B. */
                        ...
                        while k <= i__3 {
                            ...
                            i__4 = k + j * b_dim1;
                            z__2.r =
                                z__3.r * (*b.offset(i__4 as isize)).r -
                                    z__3.i * (*b.offset(i__4 as isize)).i;
                            z__2.i =
                                z__3.r * (*b.offset(i__4 as isize)).i +
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    if noconj != 0 {
                        ...
                        while k <= i__2 {
                            ...
                            i__3 = k + j * b_dim1;
                            z__2.r =
                                z__3.r * (*b.offset(i__3 as isize)).r -
                                    z__3.i * (*b.offset(i__3 as isize)).i;
                            z__2.i =
                                z__3.r * (*b.offset(i__3 as isize)).i +
                ...
                while k <= i__2 {
                    ...
                    if (*a.offset(i__3 as isize)).r != 0.0f64 ||
                        ...
                        while i__ <= i__3 {
                            ...
                            z__2.r =
                                (*a.offset(i__6 as isize)).r *
                                    (*b.offset(i__7 as isize)).r -
                                    (*a.offset(i__6 as isize)).i *
                                        (*b.offset(i__7 as isize)).i;
                            z__2.i =
                                (*a.offset(i__6 as isize)).r *
                                    (*b.offset(i__7 as isize)).i +
                                    (*a.offset(i__6 as isize)).i *
