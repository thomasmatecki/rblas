...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_strsm(mut side: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"STRSM \x00" as *const u8 as *const libc::c_char as
    ...
    if lside != 0 {
        ...
        if upper != 0 {
            ...
            while j <= i__1 {
                ...
                if nounit != 0 {
                    temp = 1.0f32 / *a.offset((j + j * a_dim1) as isize);
                    i__2 = *m;
                    i__ = 1 as libc::c_int as integer;
                    while i__ <= i__2 {
                        *b.offset((i__ + j * b_dim1) as isize) =
        ...
        while k >= 1 as libc::c_int as libc::c_long {
            if nounit != 0 {
                temp = 1.0f32 / *a.offset((k + k * a_dim1) as isize);
                i__1 = *m;
                i__ = 1 as libc::c_int as integer;
                while i__ <= i__1 {
                    *b.offset((i__ + k * b_dim1) as isize) =
