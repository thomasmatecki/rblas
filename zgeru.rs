...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zgeru(
    mut m: *mut integer,
    mut n: *mut integer,
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZGERU \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    if *incy > 0 as libc::c_int as libc::c_long {
        ...
        jy = 1 as libc::c_int as libc::c_long - (*n - 1 as libc::c_int as libc::c_long) * *incy
    }
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while j <= i__1 {
            i__2 = jy;
            if (*y.offset(i__2 as isize)).r != 0.0f64 || (*y.offset(i__2 as isize)).i != 0.0f64 {
                i__2 = jy;
                z__1.r = (*alpha).r * (*y.offset(i__2 as isize)).r
                    - (*alpha).i * (*y.offset(i__2 as isize)).i;
                z__1.i = (*alpha).r * (*y.offset(i__2 as isize)).i
                ...
                while i__ <= i__2 {
                    ...
                    i__4 = i__ + j * a_dim1;
                    i__5 = i__;
                    z__2.r = (*x.offset(i__5 as isize)).r * temp.r
                        - (*x.offset(i__5 as isize)).i * temp.i;
                    z__2.i = (*x.offset(i__5 as isize)).r * temp.i
                        + (*x.offset(i__5 as isize)).i * temp.r;
                    z__1.r = (*a.offset(i__4 as isize)).r + z__2.r;
                    z__1.i = (*a.offset(i__4 as isize)).i + z__2.i;
        ...
        if *incx > 0 as libc::c_int as libc::c_long {
            ...
            kx = 1 as libc::c_int as libc::c_long - (*m - 1 as libc::c_int as libc::c_long) * *incx
        }
        i__1 = *n;
        j = 1 as libc::c_int as integer;
        while j <= i__1 {
