...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zgeru(mut m: *mut integer, mut n: *mut integer,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"ZGERU \x00" as *const u8 as *const libc::c_char as
...
/*     accessed sequentially with one pass through A. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while j <= i__1 {
            i__2 = jy;
            if (*y.offset(i__2 as isize)).r != 0.0f64 ||
