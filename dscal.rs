...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_dscal(mut n: *mut integer,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        if !(m == 0 as libc::c_int as libc::c_long) {
            ...
            while i__ <= i__2 {
                *dx.offset(i__ as isize) = *da * *dx.offset(i__ as isize);
                i__ += 1
                /* L30: */
            }
        ...
        while i__ <= i__2 {
            ...
            *dx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize) =
                *da *
                    *dx.offset((i__ + 1 as libc::c_int as libc::c_long) as
                                   isize);
            *dx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize) =
                *da *
                    *dx.offset((i__ + 2 as libc::c_int as libc::c_long) as
                                   isize);
            *dx.offset((i__ + 3 as libc::c_int as libc::c_long) as isize) =
                *da *
                    *dx.offset((i__ + 3 as libc::c_int as libc::c_long) as
                                   isize);
            *dx.offset((i__ + 4 as libc::c_int as libc::c_long) as isize) =
                *da *
                    *dx.offset((i__ + 4 as libc::c_int as libc::c_long) as
                                   isize);
