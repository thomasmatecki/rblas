...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zgemm(mut transa: *mut libc::c_char,
...
/*     and the number of rows of  B  respectively. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"ZGEMM \x00" as *const u8 as *const libc::c_char as
            ...
            while i__ <= i__2 {
                ...
                while l <= i__3 {
                    ...
                    d_cnjg_0(&mut z__3,
                             &mut *b.offset((j + l * b_dim1) as isize));
                    z__2.r =
                        (*a.offset(i__4 as isize)).r * z__3.r -
                            (*a.offset(i__4 as isize)).i * z__3.i;
                    z__2.i =
                        (*a.offset(i__4 as isize)).r * z__3.i +
