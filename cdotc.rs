...
/* Complex */
#[no_mangle]
pub unsafe extern "C" fn f2c_cdotc(
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            ...
            i__2 = i__;
            q__2.r =
                q__3.r * (*cy.offset(i__2 as isize)).r - q__3.i * (*cy.offset(i__2 as isize)).i;
            q__2.i =
                q__3.r * (*cy.offset(i__2 as isize)).i + q__3.i * (*cy.offset(i__2 as isize)).r;
