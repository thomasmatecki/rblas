...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztrsv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTRSV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                ...
                while j >= 1 as libc::c_int as libc::c_long {
                        ...
                        || (*x.offset(i__1 as isize)).i != 0.0f64
                    {
                        ...
                        while i__ >= 1 as libc::c_int as libc::c_long {
                            ...
                            i__2 = i__;
                            i__3 = i__ + j * a_dim1;
                            z__2.r = temp.r * (*a.offset(i__3 as isize)).r
                                - temp.i * (*a.offset(i__3 as isize)).i;
                            z__2.i = temp.r * (*a.offset(i__3 as isize)).i
