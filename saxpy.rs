...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_saxpy(
    mut n: *mut integer,
    mut sa: *mut real,
    mut sx: *mut real,
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            ...
            *fresh2 += *sa * *sx.offset(i__ as isize);
            let ref mut fresh3 = *sy.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            *fresh3 += *sa * *sx.offset((i__ + 1 as libc::c_int as libc::c_long) as isize);
            let ref mut fresh4 = *sy.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            *fresh4 += *sa * *sx.offset((i__ + 2 as libc::c_int as libc::c_long) as isize);
            let ref mut fresh5 = *sy.offset((i__ + 3 as libc::c_int as libc::c_long) as isize);
            *fresh5 += *sa * *sx.offset((i__ + 3 as libc::c_int as libc::c_long) as isize);
