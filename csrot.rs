...
pub unsafe extern "C" fn csrot_(
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            i__2 = i__;
            q__2.r = *c__ * (*cx.offset(i__2 as isize)).r;
            q__2.i = *c__ * (*cx.offset(i__2 as isize)).i;
            i__3 = i__;
            q__3.r = *s * (*cy.offset(i__3 as isize)).r;
            q__3.i = *s * (*cy.offset(i__3 as isize)).i;
            ...
            i__2 = i__;
            i__3 = i__;
            q__2.r = *c__ * (*cy.offset(i__3 as isize)).r;
            q__2.i = *c__ * (*cy.offset(i__3 as isize)).i;
            i__4 = i__;
            q__3.r = *s * (*cx.offset(i__4 as isize)).r;
            q__3.i = *s * (*cx.offset(i__4 as isize)).i;
            q__1.r = q__2.r - q__3.r;
            q__1.i = q__2.i - q__3.i;
