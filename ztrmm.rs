...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztrmm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTRMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    ) != 0
    {
        ...
        while k <= i__1 {
            ...
            if temp.r != 1.0f64 || temp.i != 0.0f64 {
                i__2 = *m;
                i__ = 1 as libc::c_int as integer;
                while i__ <= i__2 {
                    i__3 = i__ + k * b_dim1;
