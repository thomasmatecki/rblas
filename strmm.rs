...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_strmm(mut side: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"STRMM \x00" as *const u8 as *const libc::c_char as
    ...
    if lside != 0 {
                ...
                while j <= i__1 {
                    ...
                    while k <= i__2 {
                        if *b.offset((k + j * b_dim1) as isize) != 0.0f32 {
                            temp =
                                *alpha * *b.offset((k + j * b_dim1) as isize);
        ...
        while k <= i__1 {
            ...
            temp = *alpha;
            if nounit != 0 { temp *= *a.offset((k + k * a_dim1) as isize) }
            if temp != 1.0f32 {
                i__2 = *m;
                i__ = 1 as libc::c_int as integer;
                while i__ <= i__2 {
