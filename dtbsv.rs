...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_dtbsv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"DTBSV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                ...
                while j >= 1 as libc::c_int as libc::c_long {
                    if *x.offset(j as isize) != 0.0f64 {
                        ...
                        if nounit != 0 {
                            ...
                            *fresh0 /= *a.offset((kplus1 + j * a_dim1) as isize)
                        }
                        ...
                        while i__ >= i__1 {
                            ...
                            *fresh1 -= temp * *a.offset((l + i__ + j * a_dim1) as isize);
                            i__ -= 1
                            /* L10: */
                        }
                    }
                ...
                while j >= 1 as libc::c_int as libc::c_long {
                    ...
                    if *x.offset(jx as isize) != 0.0f64 {
                        ...
                        if nounit != 0 {
                            ...
                            *fresh2 /= *a.offset((kplus1 + j * a_dim1) as isize)
                        }
                        ...
                        while i__ >= i__1 {
                            ...
                            *fresh3 -= temp * *a.offset((l + i__ + j * a_dim1) as isize);
                            ix -= *incx;
                            i__ -= 1
                            /* L30: */
                        }
            ...
            while j <= i__1 {
                if *x.offset(j as isize) != 0.0f64 {
                    ...
                    while i__ <= i__2 {
                        ...
                        *fresh5 -= temp * *a.offset((l + i__ + j * a_dim1) as isize);
                        i__ += 1
                        /* L50: */
                    }
                }
            ...
            while j <= i__1 {
                ...
                if *x.offset(jx as isize) != 0.0f64 {
                    ...
                    while i__ <= i__2 {
                        ...
                        *fresh7 -= temp * *a.offset((l + i__ + j * a_dim1) as isize);
                        ix += *incx;
                        i__ += 1
                        /* L70: */
                    }
