...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztpmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTPMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                ...
                while j <= i__1 {
                        ...
                        || (*x.offset(i__2 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            z__1.r = (*x.offset(i__3 as isize)).r * (*ap.offset(i__4 as isize)).r
                                - (*x.offset(i__3 as isize)).i * (*ap.offset(i__4 as isize)).i;
                            z__1.i = (*x.offset(i__3 as isize)).r * (*ap.offset(i__4 as isize)).i
                ...
                while j >= 1 as libc::c_int as libc::c_long {
                        ...
                        || (*x.offset(i__1 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            i__2 = j;
                            i__3 = kk - *n + j;
                            z__1.r = (*x.offset(i__2 as isize)).r * (*ap.offset(i__3 as isize)).r
                                - (*x.offset(i__2 as isize)).i * (*ap.offset(i__3 as isize)).i;
                            z__1.i = (*x.offset(i__2 as isize)).r * (*ap.offset(i__3 as isize)).i
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                if noconj != 0 {
                    if nounit != 0 {
                        i__1 = kk;
                        z__1.r = temp.r * (*ap.offset(i__1 as isize)).r
                            - temp.i * (*ap.offset(i__1 as isize)).i;
                        z__1.i = temp.r * (*ap.offset(i__1 as isize)).i
                    ...
                    while i__ >= 1 as libc::c_int as libc::c_long {
                        i__1 = k;
                        i__2 = i__;
                        z__2.r = (*ap.offset(i__1 as isize)).r * (*x.offset(i__2 as isize)).r
                            - (*ap.offset(i__1 as isize)).i * (*x.offset(i__2 as isize)).i;
                        z__2.i = (*ap.offset(i__1 as isize)).r * (*x.offset(i__2 as isize)).i
                    ...
                    if nounit != 0 {
                        d_cnjg_0(&mut z__2, &mut *ap.offset(kk as isize));
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j <= i__1 {
                ...
                if noconj != 0 {
                    if nounit != 0 {
                        i__2 = kk;
                        z__1.r = temp.r * (*ap.offset(i__2 as isize)).r
                            - temp.i * (*ap.offset(i__2 as isize)).i;
                        z__1.i = temp.r * (*ap.offset(i__2 as isize)).i
