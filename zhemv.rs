...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zhemv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZHEMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    ) != 0
    {
        ...
        if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
            ...
            while j <= i__1 {
                ...
                z__3.r = d__1 * temp1.r;
                z__3.i = d__1 * temp1.i;
                z__2.r = (*y.offset(i__3 as isize)).r + z__3.r;
                z__2.i = (*y.offset(i__3 as isize)).i + z__3.i;
