...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zsymm(
    ...
    let mut z__5: doublecomplex = doublecomplex { r: 0., i: 0. };
    /* Local variables */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZSYMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    ) != 0
    {
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    while k <= i__3 {
                        ...
                        i__5 = k + j * c_dim1;
                        i__6 = k + i__ * a_dim1;
                        z__2.r = temp1.r * (*a.offset(i__6 as isize)).r
                            - temp1.i * (*a.offset(i__6 as isize)).i;
                        z__2.i = temp1.r * (*a.offset(i__6 as isize)).i
                        ...
                        i__4 = k + j * b_dim1;
                        i__5 = k + i__ * a_dim1;
                        z__2.r = (*b.offset(i__4 as isize)).r * (*a.offset(i__5 as isize)).r
                            - (*b.offset(i__4 as isize)).i * (*a.offset(i__5 as isize)).i;
                        z__2.i = (*b.offset(i__4 as isize)).r * (*a.offset(i__5 as isize)).i
                    ...
                    if (*beta).r == 0.0f64 && (*beta).i == 0.0f64 {
                        i__3 = i__ + j * c_dim1;
                        i__4 = i__ + i__ * a_dim1;
                        z__2.r = temp1.r * (*a.offset(i__4 as isize)).r
                            - temp1.i * (*a.offset(i__4 as isize)).i;
                        z__2.i = temp1.r * (*a.offset(i__4 as isize)).i
                        ...
                        z__3.i = (*beta).r * (*c__.offset(i__4 as isize)).i
                            + (*beta).i * (*c__.offset(i__4 as isize)).r;
                        i__5 = i__ + i__ * a_dim1;
                        z__4.r = temp1.r * (*a.offset(i__5 as isize)).r
                            - temp1.i * (*a.offset(i__5 as isize)).i;
                        z__4.i = temp1.r * (*a.offset(i__5 as isize)).i
                            + temp1.i * (*a.offset(i__5 as isize)).r;
                        z__2.r = z__3.r + z__4.r;
                        z__2.i = z__3.i + z__4.i;
            ...
            while j <= i__1 {
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    while k <= i__2 {
                        ...
                        i__4 = k + j * c_dim1;
                        i__5 = k + i__ * a_dim1;
                        z__2.r = temp1.r * (*a.offset(i__5 as isize)).r
                            - temp1.i * (*a.offset(i__5 as isize)).i;
                        z__2.i = temp1.r * (*a.offset(i__5 as isize)).i
                            + temp1.i * (*a.offset(i__5 as isize)).r;
                        z__1.r = (*c__.offset(i__4 as isize)).r + z__2.r;
                        z__1.i = (*c__.offset(i__4 as isize)).i + z__2.i;
                        (*c__.offset(i__3 as isize)).r = z__1.r;
                        (*c__.offset(i__3 as isize)).i = z__1.i;
                        i__3 = k + j * b_dim1;
                        i__4 = k + i__ * a_dim1;
                        z__2.r = (*b.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).r
                            - (*b.offset(i__3 as isize)).i * (*a.offset(i__4 as isize)).i;
                        z__2.i = (*b.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).i
                            + (*b.offset(i__3 as isize)).i * (*a.offset(i__4 as isize)).r;
                        z__1.r = temp2.r + z__2.r;
                        z__1.i = temp2.i + z__2.i;
                        temp2.r = z__1.r;
                        temp2.i = z__1.i;
                    ...
                    if (*beta).r == 0.0f64 && (*beta).i == 0.0f64 {
                        i__2 = i__ + j * c_dim1;
                        i__3 = i__ + i__ * a_dim1;
                        z__2.r = temp1.r * (*a.offset(i__3 as isize)).r
                            - temp1.i * (*a.offset(i__3 as isize)).i;
                        z__2.i = temp1.r * (*a.offset(i__3 as isize)).i
                            + temp1.i * (*a.offset(i__3 as isize)).r;
                        z__3.r = (*alpha).r * temp2.r - (*alpha).i * temp2.i;
                        z__3.i = (*alpha).r * temp2.i + (*alpha).i * temp2.r;
                        z__1.r = z__2.r + z__3.r;
                        z__1.i = z__2.i + z__3.i;
                        (*c__.offset(i__2 as isize)).r = z__1.r;
                        (*c__.offset(i__2 as isize)).i = z__1.i
                    } else {
                        i__2 = i__ + j * c_dim1;
                        i__3 = i__ + j * c_dim1;
                        z__3.r = (*beta).r * (*c__.offset(i__3 as isize)).r
                            - (*beta).i * (*c__.offset(i__3 as isize)).i;
                        z__3.i = (*beta).r * (*c__.offset(i__3 as isize)).i
                            + (*beta).i * (*c__.offset(i__3 as isize)).r;
                        i__4 = i__ + i__ * a_dim1;
                        z__4.r = temp1.r * (*a.offset(i__4 as isize)).r
                            - temp1.i * (*a.offset(i__4 as isize)).i;
                        z__4.i = temp1.r * (*a.offset(i__4 as isize)).i
                            + temp1.i * (*a.offset(i__4 as isize)).r;
                        z__2.r = z__3.r + z__4.r;
                        z__2.i = z__3.i + z__4.i;
                        z__5.r = (*alpha).r * temp2.r - (*alpha).i * temp2.i;
        ...
        while j <= i__1 {
            i__2 = j + j * a_dim1;
            z__1.r = (*alpha).r * (*a.offset(i__2 as isize)).r
                - (*alpha).i * (*a.offset(i__2 as isize)).i;
            z__1.i = (*alpha).r * (*a.offset(i__2 as isize)).i
            ...
            if (*beta).r == 0.0f64 && (*beta).i == 0.0f64 {
                ...
                while i__ <= i__2 {
                    i__3 = i__ + j * c_dim1;
                    i__4 = i__ + j * b_dim1;
                    z__1.r = temp1.r * (*b.offset(i__4 as isize)).r
                        - temp1.i * (*b.offset(i__4 as isize)).i;
                    z__1.i = temp1.r * (*b.offset(i__4 as isize)).i
                ...
                while i__ <= i__2 {
                    i__3 = i__ + j * c_dim1;
                    i__4 = i__ + j * c_dim1;
                    z__2.r = (*beta).r * (*c__.offset(i__4 as isize)).r
                        - (*beta).i * (*c__.offset(i__4 as isize)).i;
                    z__2.i = (*beta).r * (*c__.offset(i__4 as isize)).i
                        + (*beta).i * (*c__.offset(i__4 as isize)).r;
                    i__5 = i__ + j * b_dim1;
                    z__3.r = temp1.r * (*b.offset(i__5 as isize)).r
                        - temp1.i * (*b.offset(i__5 as isize)).i;
                    z__3.i = temp1.r * (*b.offset(i__5 as isize)).i
            ...
            while k <= i__2 {
                if upper != 0 {
                    i__3 = k + j * a_dim1;
                    z__1.r = (*alpha).r * (*a.offset(i__3 as isize)).r
                        - (*alpha).i * (*a.offset(i__3 as isize)).i;
                    z__1.i = (*alpha).r * (*a.offset(i__3 as isize)).i
                ...
                while i__ <= i__3 {
                    ...
                    i__5 = i__ + j * c_dim1;
                    i__6 = i__ + k * b_dim1;
                    z__2.r = temp1.r * (*b.offset(i__6 as isize)).r
                        - temp1.i * (*b.offset(i__6 as isize)).i;
                    z__2.i = temp1.r * (*b.offset(i__6 as isize)).i
