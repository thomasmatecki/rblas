...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zherk(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZHERK \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    if *n == 0 as libc::c_int as libc::c_long
        || (*alpha == 0.0f64 || *k == 0 as libc::c_int as libc::c_long) && *beta == 1.0f64
    {
        return 0 as libc::c_int;
    }
    ...
    ) != 0
    {
        ...
        if upper != 0 {
            ...
            while j <= i__1 {
                ...
                while l <= i__2 {
                    ...
                    {
                        d_cnjg_0(&mut z__2, &mut *a.offset((j + l * a_dim1) as isize));
                        z__1.r = *alpha * z__2.r;
                        z__1.i = *alpha * z__2.i;
                        temp.r = z__1.r;
                        temp.i = z__1.i;
                        ...
                        i__4 = j + j * c_dim1;
                        i__5 = i__ + l * a_dim1;
                        z__1.r = temp.r * (*a.offset(i__5 as isize)).r
                            - temp.i * (*a.offset(i__5 as isize)).i;
                        z__1.i = temp.r * (*a.offset(i__5 as isize)).i
        ...
        while j <= i__1 {
            ...
            l = 1 as libc::c_int as integer;
            while l <= i__2 {
                d_cnjg_0(&mut z__3, &mut *a.offset((l + j * a_dim1) as isize));
                i__3 = l + j * a_dim1;
                z__2.r =
                    z__3.r * (*a.offset(i__3 as isize)).r - z__3.i * (*a.offset(i__3 as isize)).i;
                z__2.i =
                    z__3.r * (*a.offset(i__3 as isize)).i + z__3.i * (*a.offset(i__3 as isize)).r;
                z__1.r = rtemp + z__2.r;
                z__1.i = z__2.i;
                rtemp = z__1.r;
                l += 1
            ...
            if *beta == 0.0f64 {
                ...
                i__2 = j + j * c_dim1;
                i__3 = j + j * c_dim1;
                d__1 = *alpha * rtemp + *beta * (*c__.offset(i__3 as isize)).r;
                (*c__.offset(i__2 as isize)).r = d__1;
                (*c__.offset(i__2 as isize)).i = 0.0f64
            }
            j += 1
