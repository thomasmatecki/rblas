...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn xerbla_array__(
    mut srname_array__: *mut libc::c_char,
    ...
    s_copy_0(
        ...
        32 as libc::c_int as ftnlen,
        0 as libc::c_int as ftnlen,
    );
    /* Computing MIN */
    i__2 = *srname_len__;
    ...
    while i__ <= i__1 {
        *(&mut *srname
            .as_mut_ptr()
            .offset((i__ - 1 as libc::c_int as libc::c_long) as isize)
            as *mut libc::c_char as *mut libc::c_uchar) =
            *(&mut *srname_array__.offset(i__ as isize) as *mut libc::c_char as *mut libc::c_uchar);
        i__ += 1
    }
