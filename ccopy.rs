...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ccopy(mut n: *mut integer, mut cx: *mut complex,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long &&
        ...
        while i__ <= i__1 {
            i__2 = i__;
            i__3 = i__;
            (*cy.offset(i__2 as isize)).r = (*cx.offset(i__3 as isize)).r;
            (*cy.offset(i__2 as isize)).i = (*cx.offset(i__3 as isize)).i;
            i__ += 1
            /* L30: */
        }
