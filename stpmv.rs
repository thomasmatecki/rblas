...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_stpmv(mut uplo: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"STPMV \x00" as *const u8 as *const libc::c_char as
...
/*     accessed sequentially with one pass through AP. */
    if lsame__0(trans,
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                temp = *x.offset(j as isize);
                if nounit != 0 { temp *= *ap.offset(kk as isize) }
