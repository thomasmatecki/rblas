...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zhemm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZHEMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    while k <= i__3 {
                        ...
                        z__2.r = (*b.offset(i__4 as isize)).r * z__3.r
                            - (*b.offset(i__4 as isize)).i * z__3.i;
                        z__2.i = (*b.offset(i__4 as isize)).r * z__3.i
                            + (*b.offset(i__4 as isize)).i * z__3.r;
            ...
            while j <= i__1 {
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    while k <= i__2 {
                        ...
                        i__3 = k + j * b_dim1;
                        d_cnjg_0(&mut z__3, &mut *a.offset((k + i__ * a_dim1) as isize));
                        z__2.r = (*b.offset(i__3 as isize)).r * z__3.r
                            - (*b.offset(i__3 as isize)).i * z__3.i;
                        z__2.i = (*b.offset(i__3 as isize)).r * z__3.i
                            + (*b.offset(i__3 as isize)).i * z__3.r;
                        z__1.r = temp2.r + z__2.r;
                        z__1.i = temp2.i + z__2.i;
                        temp2.r = z__1.r;
                        temp2.i = z__1.i;
        ...
        while j <= i__1 {
            ...
            while k <= i__2 {
                if upper != 0 {
                    ...
                    d_cnjg_0(&mut z__2, &mut *a.offset((j + k * a_dim1) as isize));
