...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zhemm(mut side: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"ZHEMM \x00" as *const u8 as *const libc::c_char as
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    while k <= i__3 {
                        ...
                        i__4 = k + j * b_dim1;
                        d_cnjg_0(&mut z__3,
                                 &mut *a.offset((k + i__ * a_dim1) as isize));
                        z__2.r =
                            (*b.offset(i__4 as isize)).r * z__3.r -
                                (*b.offset(i__4 as isize)).i * z__3.i;
                        z__2.i =
                            (*b.offset(i__4 as isize)).r * z__3.i +
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    while k <= i__2 {
                        ...
                        d_cnjg_0(&mut z__3,
                                 &mut *a.offset((k + i__ * a_dim1) as isize));
                        z__2.r =
                            (*b.offset(i__3 as isize)).r * z__3.r -
                                (*b.offset(i__3 as isize)).i * z__3.i;
                        z__2.i =
                            (*b.offset(i__3 as isize)).r * z__3.i +
