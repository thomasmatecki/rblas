...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_csymm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CSYMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    ...
                    while k <= i__3 {
                        ...
                        i__5 = k + j * c_dim1;
                        i__6 = k + i__ * a_dim1;
                        q__2.r = temp1.r * (*a.offset(i__6 as isize)).r
                            - temp1.i * (*a.offset(i__6 as isize)).i;
                        q__2.i = temp1.r * (*a.offset(i__6 as isize)).i
                    ...
                    if (*beta).r == 0.0f32 && (*beta).i == 0.0f32 {
                        i__3 = i__ + j * c_dim1;
                        i__4 = i__ + i__ * a_dim1;
                        q__2.r = temp1.r * (*a.offset(i__4 as isize)).r
                            - temp1.i * (*a.offset(i__4 as isize)).i;
                        q__2.i = temp1.r * (*a.offset(i__4 as isize)).i
                        ...
                        q__3.i = (*beta).r * (*c__.offset(i__4 as isize)).i
                            + (*beta).i * (*c__.offset(i__4 as isize)).r;
                        i__5 = i__ + i__ * a_dim1;
                        q__4.r = temp1.r * (*a.offset(i__5 as isize)).r
                            - temp1.i * (*a.offset(i__5 as isize)).i;
                        q__4.i = temp1.r * (*a.offset(i__5 as isize)).i
            ...
            while j <= i__1 {
                ...
                while i__ >= 1 as libc::c_int as libc::c_long {
                    ...
                    while k <= i__2 {
                        ...
                        i__3 = k + j * b_dim1;
                        i__4 = k + i__ * a_dim1;
                        q__2.r = (*b.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).r
                            - (*b.offset(i__3 as isize)).i * (*a.offset(i__4 as isize)).i;
                        q__2.i = (*b.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).i
                    ...
                    if (*beta).r == 0.0f32 && (*beta).i == 0.0f32 {
                        i__2 = i__ + j * c_dim1;
                        i__3 = i__ + i__ * a_dim1;
                        q__2.r = temp1.r * (*a.offset(i__3 as isize)).r
                            - temp1.i * (*a.offset(i__3 as isize)).i;
                        q__2.i = temp1.r * (*a.offset(i__3 as isize)).i
                        ...
                        i__2 = i__ + j * c_dim1;
                        i__3 = i__ + j * c_dim1;
                        q__3.r = (*beta).r * (*c__.offset(i__3 as isize)).r
                            - (*beta).i * (*c__.offset(i__3 as isize)).i;
                        q__3.i = (*beta).r * (*c__.offset(i__3 as isize)).i
                            + (*beta).i * (*c__.offset(i__3 as isize)).r;
                        i__4 = i__ + i__ * a_dim1;
                        q__4.r = temp1.r * (*a.offset(i__4 as isize)).r
                            - temp1.i * (*a.offset(i__4 as isize)).i;
                        q__4.i = temp1.r * (*a.offset(i__4 as isize)).i
                            + temp1.i * (*a.offset(i__4 as isize)).r;
                        q__2.r = q__3.r + q__4.r;
                        q__2.i = q__3.i + q__4.i;
                        q__5.r = (*alpha).r * temp2.r - (*alpha).i * temp2.i;
        ...
        while j <= i__1 {
            ...
            if (*beta).r == 0.0f32 && (*beta).i == 0.0f32 {
                ...
                while i__ <= i__2 {
                    i__3 = i__ + j * c_dim1;
                    i__4 = i__ + j * b_dim1;
                    q__1.r = temp1.r * (*b.offset(i__4 as isize)).r
                        - temp1.i * (*b.offset(i__4 as isize)).i;
                    q__1.i = temp1.r * (*b.offset(i__4 as isize)).i
                ...
                while i__ <= i__2 {
                    i__3 = i__ + j * c_dim1;
                    i__4 = i__ + j * c_dim1;
                    q__2.r = (*beta).r * (*c__.offset(i__4 as isize)).r
                        - (*beta).i * (*c__.offset(i__4 as isize)).i;
                    q__2.i = (*beta).r * (*c__.offset(i__4 as isize)).i
                        + (*beta).i * (*c__.offset(i__4 as isize)).r;
                    i__5 = i__ + j * b_dim1;
                    q__3.r = temp1.r * (*b.offset(i__5 as isize)).r
                        - temp1.i * (*b.offset(i__5 as isize)).i;
                    q__3.i = temp1.r * (*b.offset(i__5 as isize)).i
            ...
            while k <= i__2 {
                ...
                while i__ <= i__3 {
                    ...
                    i__5 = i__ + j * c_dim1;
                    i__6 = i__ + k * b_dim1;
                    q__2.r = temp1.r * (*b.offset(i__6 as isize)).r
                        - temp1.i * (*b.offset(i__6 as isize)).i;
                    q__2.i = temp1.r * (*b.offset(i__6 as isize)).i
