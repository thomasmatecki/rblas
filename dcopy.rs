...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_dcopy(mut n: *mut integer,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long &&
        ...
        if !(m == 0 as libc::c_int as libc::c_long) {
            ...
            while i__ <= i__1 {
                *dy.offset(i__ as isize) = *dx.offset(i__ as isize);
                i__ += 1
                /* L30: */
            }
        ...
        while i__ <= i__1 {
            ...
            *dy.offset((i__ + 3 as libc::c_int as libc::c_long) as isize) =
                *dx.offset((i__ + 3 as libc::c_int as libc::c_long) as isize);
            *dy.offset((i__ + 4 as libc::c_int as libc::c_long) as isize) =
                *dx.offset((i__ + 4 as libc::c_int as libc::c_long) as isize);
            *dy.offset((i__ + 5 as libc::c_int as libc::c_long) as isize) =
                *dx.offset((i__ + 5 as libc::c_int as libc::c_long) as isize);
            *dy.offset((i__ + 6 as libc::c_int as libc::c_long) as isize) =
                *dx.offset((i__ + 6 as libc::c_int as libc::c_long) as isize);
...
/*          not equal to 1 */
        ...
        i__ = 1 as libc::c_int as integer;
        while i__ <= i__1 {
            *dy.offset(iy as isize) = *dx.offset(ix as isize);
            ix += *incx;
            iy += *incy;
            i__ += 1
            /* L10: */
