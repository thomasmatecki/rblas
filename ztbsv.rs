...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztbsv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTBSV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                        ...
                        || (*x.offset(i__1 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            z_div_0(
                                ...
                                &mut *a.offset((kplus1 + j * a_dim1) as isize),
                            );
                        ...
                        while i__ >= i__1 {
                            ...
                            i__3 = i__;
                            i__4 = l + i__ + j * a_dim1;
                            z__2.r = temp.r * (*a.offset(i__4 as isize)).r
                                - temp.i * (*a.offset(i__4 as isize)).i;
                            z__2.i = temp.r * (*a.offset(i__4 as isize)).i
                ...
                if (*x.offset(i__2 as isize)).r != 0.0f64 || (*x.offset(i__2 as isize)).i != 0.0f64
                {
                    ...
                    if nounit != 0 {
                        ...
                        z_div_0(
                            ...
                            &mut *x.offset(j as isize),
                            &mut *a
                                .offset((j * a_dim1 + 1 as libc::c_int as libc::c_long) as isize),
                        );
                        (*x.offset(i__2 as isize)).r = z__1.r;
                        (*x.offset(i__2 as isize)).i = z__1.i
                    }
            ...
            while j <= i__1 {
                ...
                if noconj != 0 {
                    ...
                    while i__ <= i__4 {
                        i__2 = l + i__ + j * a_dim1;
                        i__3 = i__;
                        z__2.r = (*a.offset(i__2 as isize)).r * (*x.offset(i__3 as isize)).r
                            - (*a.offset(i__2 as isize)).i * (*x.offset(i__3 as isize)).i;
                        z__2.i = (*a.offset(i__2 as isize)).r * (*x.offset(i__3 as isize)).i
                            + (*a.offset(i__2 as isize)).i * (*x.offset(i__3 as isize)).r;
        ...
        while j >= 1 as libc::c_int as libc::c_long {
            ...
            if noconj != 0 {
                ...
                while i__ >= i__2 {
                    i__1 = l + i__ + j * a_dim1;
                    i__4 = i__;
                    z__2.r = (*a.offset(i__1 as isize)).r * (*x.offset(i__4 as isize)).r
                        - (*a.offset(i__1 as isize)).i * (*x.offset(i__4 as isize)).i;
                    z__2.i = (*a.offset(i__1 as isize)).r * (*x.offset(i__4 as isize)).i
                        + (*a.offset(i__1 as isize)).i * (*x.offset(i__4 as isize)).r;
                    z__1.r = temp.r - z__2.r;
                    z__1.i = temp.i - z__2.i;
                    temp.r = z__1.r;
                    temp.i = z__1.i;
