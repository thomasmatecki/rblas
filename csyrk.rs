...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_csyrk(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CSYRK \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
        ...
        while j <= i__1 {
            ...
            while i__ <= i__2 {
                ...
                while l <= i__3 {
                    i__4 = l + i__ * a_dim1;
                    i__5 = l + j * a_dim1;
                    q__2.r = (*a.offset(i__4 as isize)).r * (*a.offset(i__5 as isize)).r
                        - (*a.offset(i__4 as isize)).i * (*a.offset(i__5 as isize)).i;
                    q__2.i = (*a.offset(i__4 as isize)).r * (*a.offset(i__5 as isize)).i
