...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ssyr2k(mut uplo: *mut libc::c_char,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"SSYR2K\x00" as *const u8 as *const libc::c_char as
                ...
                while l <= i__2 {
                    if *a.offset((j + l * a_dim1) as isize) != 0.0f32 ||
                        ...
                        while i__ <= i__3 {
                            *c__.offset((i__ + j * c_dim1) as isize) =
                                *c__.offset((i__ + j * c_dim1) as isize) +
                                    *a.offset((i__ + l * a_dim1) as isize) *
                                        temp1 +
                                    *b.offset((i__ + l * b_dim1) as isize) *
                                        temp2;
                            i__ += 1
                            /* L130: */
                            /* L110: */
        ...
        while j <= i__1 {
            ...
            while i__ <= i__2 {
                ...
                while l <= i__3 {
                    ...
                    temp2 +=
                        *b.offset((l + i__ * b_dim1) as isize) *
