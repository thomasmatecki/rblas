...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ctrmm(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CTRMM \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
        ...
        if upper != 0 {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                while k <= i__1 {
                    ...
                    {
                        i__2 = k + j * a_dim1;
                        q__1.r = (*alpha).r * (*a.offset(i__2 as isize)).r
                            - (*alpha).i * (*a.offset(i__2 as isize)).i;
                        q__1.i = (*alpha).r * (*a.offset(i__2 as isize)).i
            ...
            while j <= i__2 {
                ...
                if (*a.offset(i__3 as isize)).r != 0.0f32 || (*a.offset(i__3 as isize)).i != 0.0f32
                {
                    if noconj != 0 {
                        ...
                        r_cnjg_0(&mut q__2, &mut *a.offset((j + k * a_dim1) as isize));
