...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_cherk(mut uplo: *mut libc::c_char,
                                   mut trans: *mut libc::c_char,
                                   mut n: *mut integer, mut k: *mut integer,
                                   mut alpha: *mut real, mut a: *mut complex,
                                   mut lda: *mut integer, mut beta: *mut real,
                                   mut c__: *mut complex,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"CHERK \x00" as *const u8 as *const libc::c_char as
    ...
    if lsame__0(trans,
        ...
        while j <= i__1 {
            ...
            while l <= i__2 {
                ...
                i__3 = l + j * a_dim1;
                q__2.r =
                    q__3.r * (*a.offset(i__3 as isize)).r -
                        q__3.i * (*a.offset(i__3 as isize)).i;
                q__2.i =
                    q__3.r * (*a.offset(i__3 as isize)).i +
                        q__3.i * (*a.offset(i__3 as isize)).r;
                q__1.r = rtemp + q__2.r;
                q__1.i = q__2.i;
                rtemp = q__1.r;
                l += 1
