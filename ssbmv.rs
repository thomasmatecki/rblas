...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ssbmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"SSBMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
        ...
        if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
            ...
            while j <= i__1 {
                ...
                while i__ <= i__4 {
                    ...
                    *fresh0 += temp1 * *a.offset((l + i__ + j * a_dim1) as isize);
                    temp2 += *a.offset((l + i__ + j * a_dim1) as isize) * *x.offset(i__ as isize);
                    i__ += 1
                    /* Computing MAX */
                    /* L50: */
                }
            ...
            while j <= i__1 {
                ...
                while i__ <= i__3 {
                    ...
                    *fresh1 += temp1 * *a.offset((l + i__ + j * a_dim1) as isize);
                    temp2 += *a.offset((l + i__ + j * a_dim1) as isize) * *x.offset(ix as isize);
                    ix += *incx;
                    iy += *incy;
                    i__ += 1
                    /* Computing MAX */
    ...
    } else if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long
    {
        ...
        while j <= i__1 {
            ...
            *fresh2 += temp1 * *a.offset((j * a_dim1 + 1 as libc::c_int as libc::c_long) as isize);
        ...
        while j <= i__1 {
            ...
            *fresh5 += temp1 * *a.offset((j * a_dim1 + 1 as libc::c_int as libc::c_long) as isize);
            l = 1 as libc::c_int as libc::c_long - j;
            ix = jx;
            iy = jy;
            /* L120: */
