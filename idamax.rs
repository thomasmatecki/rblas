...
*/
#[no_mangle]
pub unsafe extern "C" fn f2c_idamax(
    mut n: *mut integer,
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        dmax__ = if *dx.offset(1 as libc::c_int as isize) >= 0 as libc::c_int as libc::c_double {
        ...
        while i__ <= i__1 {
            ...
            }) <= dmax__)
            {
                ret_val = i__;
                d__1 = *dx.offset(i__ as isize);
                dmax__ = (if d__1 >= 0 as libc::c_int as libc::c_double {
                    d__1
                } else {
                    -d__1
                })
