...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_chpmv(mut uplo: *mut libc::c_char,
                                   mut n: *mut integer,
                                   mut alpha: *mut complex,
                                   mut ap: *mut complex, mut x: *mut complex,
...
/*     .. */
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(b"CHPMV \x00" as *const u8 as *const libc::c_char as
