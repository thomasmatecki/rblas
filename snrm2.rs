...
*/
#[no_mangle]
pub unsafe extern "C" fn f2c_snrm2(
    mut n: *mut integer,
    mut x: *mut real,
    ...
    if *n < 1 as libc::c_int as libc::c_long || *incx < 1 as libc::c_int as libc::c_long {
        ...
        norm = if *x.offset(1 as libc::c_int as isize) >= 0 as libc::c_int as libc::c_float {
        ...
        } != 0
        {
            if *x.offset(ix as isize) != 0.0f32 {
                ...
                absxi = (if r__1 >= 0 as libc::c_int as libc::c_float {
                    r__1
                } else {
                    -r__1
                }) as doublereal as real;
