...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ctpsv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CTPSV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                ...
                while j >= 1 as libc::c_int as libc::c_long {
                        ...
                        || (*x.offset(i__1 as isize)).i != 0.0f32
                    {
                        ...
                        while i__ >= 1 as libc::c_int as libc::c_long {
                            ...
                            i__2 = i__;
                            i__3 = k;
                            q__2.r = temp.r * (*ap.offset(i__3 as isize)).r
                                - temp.i * (*ap.offset(i__3 as isize)).i;
                            q__2.i = temp.r * (*ap.offset(i__3 as isize)).i
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                if noconj != 0 {
                    ...
                    if nounit != 0 {
                        r_cnjg_0(&mut q__2, &mut *ap.offset((kk - *n + j) as isize));
                        c_div_0(&mut q__1, &mut temp, &mut q__2);
                        temp.r = q__1.r;
                        temp.i = q__1.i
                    }
