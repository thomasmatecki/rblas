...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zaxpy(mut n: *mut integer,
...
/*     .. */
    ...
    if dcabs1__0(za) == 0.0f64 { return 0 as libc::c_int }
    if *incx == 1 as libc::c_int as libc::c_long &&
        ...
        while i__ <= i__1 {
            ...
            i__4 = i__;
            z__2.r =
                (*za).r * (*zx.offset(i__4 as isize)).r -
                    (*za).i * (*zx.offset(i__4 as isize)).i;
            z__2.i =
                (*za).r * (*zx.offset(i__4 as isize)).i +
                    (*za).i * (*zx.offset(i__4 as isize)).r;
