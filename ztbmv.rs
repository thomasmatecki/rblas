...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztbmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTBMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    ) != 0
    {
        ...
        ) != 0
        {
                ...
                while j <= i__1 {
                        ...
                        || (*x.offset(i__2 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            z__1.r = (*x.offset(i__2 as isize)).r * (*a.offset(i__3 as isize)).r
                                - (*x.offset(i__2 as isize)).i * (*a.offset(i__3 as isize)).i;
                            z__1.i = (*x.offset(i__2 as isize)).r * (*a.offset(i__3 as isize)).i
                ...
                while j <= i__1 {
                        ...
                        || (*x.offset(i__4 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            z__1.r = (*x.offset(i__4 as isize)).r * (*a.offset(i__2 as isize)).r
                                - (*x.offset(i__4 as isize)).i * (*a.offset(i__2 as isize)).i;
                            z__1.i = (*x.offset(i__4 as isize)).r * (*a.offset(i__2 as isize)).i
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                i__1 = j;
                if (*x.offset(i__1 as isize)).r != 0.0f64 || (*x.offset(i__1 as isize)).i != 0.0f64
                {
                    i__1 = j;
                    ...
                    while i__ >= i__4 {
                        ...
                        i__3 = i__;
                        i__2 = l + i__ + j * a_dim1;
                        z__2.r = temp.r * (*a.offset(i__2 as isize)).r
                            - temp.i * (*a.offset(i__2 as isize)).i;
                        z__2.i = temp.r * (*a.offset(i__2 as isize)).i
                    ...
                    if nounit != 0 {
                        ...
                        z__1.r = (*x.offset(i__1 as isize)).r * (*a.offset(i__3 as isize)).r
                            - (*x.offset(i__1 as isize)).i * (*a.offset(i__3 as isize)).i;
                        z__1.i = (*x.offset(i__1 as isize)).r * (*a.offset(i__3 as isize)).i
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                if (*x.offset(i__4 as isize)).r != 0.0f64 || (*x.offset(i__4 as isize)).i != 0.0f64
                {
                    ...
                    if nounit != 0 {
                        ...
                        z__1.r = (*x.offset(i__4 as isize)).r * (*a.offset(i__1 as isize)).r
                            - (*x.offset(i__4 as isize)).i * (*a.offset(i__1 as isize)).i;
                        z__1.i = (*x.offset(i__4 as isize)).r * (*a.offset(i__1 as isize)).i
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                if noconj != 0 {
                    if nounit != 0 {
                        i__3 = kplus1 + j * a_dim1;
                        z__1.r = temp.r * (*a.offset(i__3 as isize)).r
                            - temp.i * (*a.offset(i__3 as isize)).i;
                        z__1.i = temp.r * (*a.offset(i__3 as isize)).i
                    ...
                    while i__ >= i__3 {
                        i__4 = l + i__ + j * a_dim1;
                        i__1 = i__;
                        z__2.r = (*a.offset(i__4 as isize)).r * (*x.offset(i__1 as isize)).r
                            - (*a.offset(i__4 as isize)).i * (*x.offset(i__1 as isize)).i;
                        z__2.i = (*a.offset(i__4 as isize)).r * (*x.offset(i__1 as isize)).i
                    ...
                    if nounit != 0 {
                        d_cnjg_0(&mut z__2, &mut *a.offset((kplus1 + j * a_dim1) as isize));
                    ...
                    i__ = j - 1 as libc::c_int as libc::c_long;
                    while i__ >= i__3 {
                        d_cnjg_0(&mut z__3, &mut *a.offset((l + i__ + j * a_dim1) as isize));
                        i__4 = i__;
                        z__2.r = z__3.r * (*x.offset(i__4 as isize)).r
                            - z__3.i * (*x.offset(i__4 as isize)).i;
                        z__2.i = z__3.r * (*x.offset(i__4 as isize)).i
        ...
        while j <= i__3 {
            ...
            if noconj != 0 {
                if nounit != 0 {
                    ...
                    z__1.r = temp.r * (*a.offset(i__4 as isize)).r
                        - temp.i * (*a.offset(i__4 as isize)).i;
                    z__1.i = temp.r * (*a.offset(i__4 as isize)).i
                ...
                while i__ <= i__4 {
                    i__1 = l + i__ + j * a_dim1;
                    i__2 = i__;
                    z__2.r = (*a.offset(i__1 as isize)).r * (*x.offset(i__2 as isize)).r
                        - (*a.offset(i__1 as isize)).i * (*x.offset(i__2 as isize)).i;
                    z__2.i = (*a.offset(i__1 as isize)).r * (*x.offset(i__2 as isize)).i
                ...
                while i__ <= i__4 {
                    d_cnjg_0(&mut z__3, &mut *a.offset((l + i__ + j * a_dim1) as isize));
                    i__1 = i__;
                    z__2.r = z__3.r * (*x.offset(i__1 as isize)).r
                        - z__3.i * (*x.offset(i__1 as isize)).i;
                    z__2.i = z__3.r * (*x.offset(i__1 as isize)).i
