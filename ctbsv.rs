...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ctbsv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"CTBSV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
            ...
            while j <= i__1 {
                ...
                if noconj != 0 {
                    ...
                    while i__ <= i__4 {
                        i__2 = l + i__ + j * a_dim1;
                        i__3 = i__;
                        q__2.r = (*a.offset(i__2 as isize)).r * (*x.offset(i__3 as isize)).r
                            - (*a.offset(i__2 as isize)).i * (*x.offset(i__3 as isize)).i;
                        q__2.i = (*a.offset(i__2 as isize)).r * (*x.offset(i__3 as isize)).i
        ...
        while j >= 1 as libc::c_int as libc::c_long {
            ...
            if noconj != 0 {
                ...
                while i__ >= i__2 {
                    i__1 = l + i__ + j * a_dim1;
                    i__4 = i__;
                    q__2.r = (*a.offset(i__1 as isize)).r * (*x.offset(i__4 as isize)).r
                        - (*a.offset(i__1 as isize)).i * (*x.offset(i__4 as isize)).i;
                    q__2.i = (*a.offset(i__1 as isize)).r * (*x.offset(i__4 as isize)).i
