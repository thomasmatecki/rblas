...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_cscal(mut n: *mut integer, mut ca: *mut complex,
                                   mut cx: *mut complex,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__2 {
            ...
            i__3 = i__;
            q__1.r =
                (*ca).r * (*cx.offset(i__3 as isize)).r -
                    (*ca).i * (*cx.offset(i__3 as isize)).i;
            q__1.i =
                (*ca).r * (*cx.offset(i__3 as isize)).i +
                    (*ca).i * (*cx.offset(i__3 as isize)).r;
        ...
        while if i__2 < 0 as libc::c_int as libc::c_long {
            ...
            i__4 = i__;
            q__1.r =
                (*ca).r * (*cx.offset(i__4 as isize)).r -
                    (*ca).i * (*cx.offset(i__4 as isize)).i;
            q__1.i =
                (*ca).r * (*cx.offset(i__4 as isize)).i +
                    (*ca).i * (*cx.offset(i__4 as isize)).r;
