...
*/
#[no_mangle]
pub unsafe extern "C" fn f2c_sasum(mut n: *mut integer, mut sx: *mut real,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        if m == 0 as libc::c_int as libc::c_long {
            ...
            } else { current_block = 10493328989435379652; }
        }
        match current_block {
                ...
                while i__ <= i__2 {
                    ...
                    r__4 =
                        *sx.offset((i__ + 3 as libc::c_int as libc::c_long) as
                                       isize);
                    r__5 =
                        *sx.offset((i__ + 4 as libc::c_int as libc::c_long) as
                                       isize);
                    r__6 =
                        *sx.offset((i__ + 5 as libc::c_int as libc::c_long) as
                                       isize);
                    stemp =
                        (stemp as libc::c_double +
                             (if r__1 >= 0 as libc::c_int as libc::c_float {
