...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zscal(mut n: *mut integer,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            ...
            i__3 = i__;
            z__1.r =
                (*za).r * (*zx.offset(i__3 as isize)).r -
                    (*za).i * (*zx.offset(i__3 as isize)).i;
            z__1.i =
                (*za).r * (*zx.offset(i__3 as isize)).i +
                    (*za).i * (*zx.offset(i__3 as isize)).r;
