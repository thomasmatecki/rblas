...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zcopy(mut n: *mut integer,
...
/*     .. */
    ...
    if *incx == 1 as libc::c_int as libc::c_long &&
        ...
        while i__ <= i__1 {
            i__2 = i__;
            i__3 = i__;
            (*zy.offset(i__2 as isize)).r = (*zx.offset(i__3 as isize)).r;
            (*zy.offset(i__2 as isize)).i = (*zx.offset(i__3 as isize)).i;
            i__ += 1
            /* L30: */
        }
