...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_ztrmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZTRMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
                ...
                while j <= i__1 {
                        ...
                        || (*x.offset(i__2 as isize)).i != 0.0f64
                    {
                        ...
                        if nounit != 0 {
                            ...
                            i__3 = j;
                            i__4 = j + j * a_dim1;
                            z__1.r = (*x.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).r
                                - (*x.offset(i__3 as isize)).i * (*a.offset(i__4 as isize)).i;
                            z__1.i = (*x.offset(i__3 as isize)).r * (*a.offset(i__4 as isize)).i
    ...
    ) != 0
    {
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j >= 1 as libc::c_int as libc::c_long {
                ...
                if noconj != 0 {
                    if nounit != 0 {
                        i__1 = j + j * a_dim1;
                        z__1.r = temp.r * (*a.offset(i__1 as isize)).r
                            - temp.i * (*a.offset(i__1 as isize)).i;
                        z__1.i = temp.r * (*a.offset(i__1 as isize)).i
                    ...
                    if nounit != 0 {
                        d_cnjg_0(&mut z__2, &mut *a.offset((j + j * a_dim1) as isize));
        ...
        while j <= i__1 {
            ...
            if noconj != 0 {
                if nounit != 0 {
                    i__2 = j + j * a_dim1;
                    z__1.r = temp.r * (*a.offset(i__2 as isize)).r
                        - temp.i * (*a.offset(i__2 as isize)).i;
                    z__1.i = temp.r * (*a.offset(i__2 as isize)).i
