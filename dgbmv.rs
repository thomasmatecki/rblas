...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_dgbmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"DGBMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    ) != 0
    {
            ...
            while j <= i__1 {
                if *x.offset(jx as isize) != 0.0f64 {
                    ...
                    while i__ <= i__4 {
                        ...
                        *fresh0 += temp * *a.offset((k + i__ + j * a_dim1) as isize);
                        i__ += 1
                        /* L50: */
                    }
                }
            ...
            while j <= i__1 {
                if *x.offset(jx as isize) != 0.0f64 {
                    ...
                    while i__ <= i__3 {
                        ...
                        *fresh1 += temp * *a.offset((k + i__ + j * a_dim1) as isize);
                        iy += *incy;
                        i__ += 1
                        /* L70: */
                    }
        ...
        if *incx == 1 as libc::c_int as libc::c_long {
            ...
            while j <= i__1 {
                ...
                while i__ <= i__2 {
                    temp += *a.offset((k + i__ + j * a_dim1) as isize) * *x.offset(i__ as isize);
                    i__ += 1
                    /* Computing MAX */
                    /* Computing MIN */
                    /* L90: */
            ...
            while j <= i__1 {
                ...
                i__ = if i__2 >= i__3 { i__2 } else { i__3 };
                while i__ <= i__4 {
                    temp += *a.offset((k + i__ + j * a_dim1) as isize) * *x.offset(ix as isize);
                    ix += *incx;
                    i__ += 1
                    /* Computing MAX */
                    /* Computing MIN */
