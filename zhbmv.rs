...
/* Subroutine */
#[no_mangle]
pub unsafe extern "C" fn f2c_zhbmv(
    ...
    if info != 0 as libc::c_int as libc::c_long {
        xerbla__0(
            b"ZHBMV \x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
            &mut info,
        );
    ...
    } else if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long
    {
        ...
        while j <= i__1 {
            i__3 = j;
            z__1.r = (*alpha).r * (*x.offset(i__3 as isize)).r
                - (*alpha).i * (*x.offset(i__3 as isize)).i;
            z__1.i = (*alpha).r * (*x.offset(i__3 as isize)).i
            ...
            while i__ <= i__3 {
                ...
                i__4 = i__;
                z__2.r =
                    z__3.r * (*x.offset(i__4 as isize)).r - z__3.i * (*x.offset(i__4 as isize)).i;
                z__2.i =
                    z__3.r * (*x.offset(i__4 as isize)).i + z__3.i * (*x.offset(i__4 as isize)).r;
                z__1.r = temp2.r + z__2.r;
                z__1.i = temp2.i + z__2.i;
                temp2.r = z__1.r;
                temp2.i = z__1.i;
