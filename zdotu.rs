...
/* Double Complex */
#[no_mangle]
pub unsafe extern "C" fn f2c_zdotu(
    ...
    if *incx == 1 as libc::c_int as libc::c_long && *incy == 1 as libc::c_int as libc::c_long {
        ...
        while i__ <= i__1 {
            i__2 = i__;
            i__3 = i__;
            z__2.r = (*zx.offset(i__2 as isize)).r * (*zy.offset(i__3 as isize)).r
                - (*zx.offset(i__2 as isize)).i * (*zy.offset(i__3 as isize)).i;
            z__2.i = (*zx.offset(i__2 as isize)).r * (*zy.offset(i__3 as isize)).i
                + (*zx.offset(i__2 as isize)).i * (*zy.offset(i__3 as isize)).r;
